...
class SAM2Image:
    ...
    def add_point(self, point_coords, is_positive, label_id):
    ...
    def set_box(self, box_coords, label_id: int):
    ...
    def decode_mask(self, label_id: int):
    ...
    def merge_points_and_boxes(self, label_id: int):
        concat_coords = []
        concat_labels = []
    ...
    def remove_point(self,  point_coords, label_id):
    ...
    def remove_box(self, label_id: int):
...
class SAM2ImageDecoder:
    ...
    def prepare_inputs(self, image_embed,
    ...
    def set_image_size(self, orig_im_size) -> None:
...
if __name__ == '__main__':
    ...
    cv2.circle(masked_img, point_coords, 5, (0, 255, 0), 1)
